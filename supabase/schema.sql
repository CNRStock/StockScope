...
drop policy if exists "read own profile" on public.profiles;drop policy if exists "read own research" on public.saved_research;drop policy if exists "save own research" on public.saved_research;drop policy if exists "delete own research" on public.saved_research;drop policy if exists "read own usage" on public.usage_events;
